"""Pytest fixtures for live_chat module tests."""
import uuid
import pytest
...
@pytest.fixture
def chat_conversation(db, hub_id):
    """Create a test ChatConversation."""
    return ChatConversation.objects.create(
        hub_id=hub_id,
        visitor_name='Test Visitor Name',
...
@pytest.fixture
def chat_message(db, hub_id):
    """Create a test ChatMessage."""
    return ChatMessage.objects.create(
        hub_id=hub_id,
        sender_type='Test Sender Type',
